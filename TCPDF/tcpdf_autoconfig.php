...
if (!defined('PDF_HEADER_LOGO')) {
	$logo_projecao = '';
	if (@file_exists(K_PATH_IMAGES.'logo-menu3.png')) {
        $logo_projecao = 'logo-menu3.png';
	}
	define ('PDF_HEADER_LOGO', $logo_projecao);
}

if (!defined('PDF_HEADER_LOGO_WIDTH')) {
	if (!empty($logo_projecao)) {
...
if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "exemplo");
}
